"""
Django settings for patient_rice_42369 project.
...
ROOT_URLCONF = 'patient_rice_42369.urls'
...
WSGI_APPLICATION = 'patient_rice_42369.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_rice_42369 API",
    "DESCRIPTION": "API documentation for patient_rice_42369 App",
    "VERSION": "v1",
}
